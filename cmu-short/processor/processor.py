...
class Processor(IO):
    ...
    def get_parser(add_help=False):
        ...
        parser.add_argument('--save_interval', type=int, default=1000, help='the interval for storing models (#iteration)')
        parser.add_argument('--eval_interval', type=int, default=1000, help='the interval for evaluating models (#iteration)')
